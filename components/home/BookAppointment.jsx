...
const BookAppointment = () => {
  return (
    <Container tag="section" variant="lg" className="book-appointment">
      <div className="book-appointment__wrapper">
        <div className="book-appointment__wrapper--map book-appointment__wrapper--col">
          <iframe 
        ...
        <div className="book-appointment__wrapper--content book-appointment__wrapper--col">
